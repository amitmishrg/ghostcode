...
export function buildSystemPrompt({
  ...
  const parts: string[] = [];
  const hasProjectMemory = Boolean(projectMemory?.trim());

  if (hasProjectMemory) {
    parts.push(`## Project instructions

The following was loaded from Ghost.md for this project. Treat it as your primary role and behavior. When it conflicts with default GhostCode guidance below, follow the project instructions.
